...
function Navbar2() {
        const navItems = (
            <>
                <li><Link className='text-xl' to='/LandingPage2'>Home</Link></li>
                <li><Link className='text-xl' to='/Category2'>Category</Link></li>
    ...
    <div className='fixed top-0 left-0 right-0 z-10 '>
                <div className=" bg-base-100 px-4 flex justify-between items-center">
                  ...
                  <div className='flex justify-center items-center p-2 bg-blue-400  text-white text-lg rounded-md'>
                        <button onClick={handleLogout}><Link to={'/Login'} className='flex space-x-2'><LogOut /><span>Logout</span></Link></button>
                  </div>
                </div>
            </div>
  )
